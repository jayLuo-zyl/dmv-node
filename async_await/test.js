...
//         let ability1 = awData.abilities[0].ability.name;
//         let ability2 = awData.abilities[1].ability.name;
//         let ability3 = awData.abilities[2].ability.name;
//         let name = (awData.name).toUpperCase();
